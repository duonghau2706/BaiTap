package Buoi6_bai2.mainProgram;

import java.util.Scanner;

import Buoi6_bai2.entity.KhoaHoc;
import Buoi6_bai2.entity.NgoaiVan;
import Buoi6_bai2.entity.VanHoc;
import Buoi6_bai2.singleton.Cart;
...
public class MainProgram {
	...
	public static void main(String[] args) {
		...
		Inventory.addToInventory(new VanHoc("Vanhoc1", 55, 2, 2, "nuoc ngoai"));
		Inventory.addToInventory(new KhoaHoc("Khoahoc", 100, 10, 2002, "tu nhien"));
		Inventory.addToInventory(new NgoaiVan("Ngoaivan1", 200, 50, 128372, "my"));
		Inventory.addToInventory(new NgoaiVan("Ngoaivan2", 500, 100, 992398, "anh"));
